...
#define MY_VERSION SHORT_BUILD_VERSION "-a"
#define STRING_CONFIG_H_AUTHOR "(junand, " MY_VERSION ", " __DATE__ ")" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "K8200 " MY_VERSION
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {64.25,64.25,2133,1150}
/**
 * Default Max Feed Rate (mm/s)
 * Override with M203
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          {80, 80, 50, 500}    // (mm/sec)    
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      {100,100,100,500}
...
#define Z_SERVO_ANGLES {55,150}  // Z Servo Deploy and Stow angles
 ...
 *    (0,0)
 */
// #define X_PROBE_OFFSET_FROM_EXTRUDER -24.8  // X offset: -left  +right  [of the nozzle]
// #define Y_PROBE_OFFSET_FROM_EXTRUDER +29.5  // Y offset: -front +behind [the nozzle]
#define X_PROBE_OFFSET_FROM_EXTRUDER -25  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER +29  // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.01   // Z offset: -below +above  [the nozzle]
